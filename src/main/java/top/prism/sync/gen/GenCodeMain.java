        ...
        for(String table:tables ){
            ...
            FastAutoGenerator.create("jdbc:sqlite:D:\\Works\\datapulse.db", "", "")
                    ...
                    .injectionConfig(consumer -> {
                        ...
                        CustomFile reqVO=new CustomFile.Builder().filePath("src/main/java/").packageName("top/prism/sync/business/module/"+table.replace("_","")+"/vo/").fileName("ReqVO.java").templatePath("/templates/req.java.ftl").build();
                        customFile.add(reqVO);
                        CustomFile resVO=new CustomFile.Builder().filePath("src/main/java/").packageName("top/prism/sync/business/module/"+table.replace("_","")+"/vo/").fileName("ResVO.java").templatePath("/templates/res.java.ftl").build();
                        customFile.add(resVO);
                        CustomFile mapstruct=new CustomFile.Builder().filePath("src/main/java/").packageName("top/prism/sync/business/module/"+table.replace("_","")+"/convert/").fileName("Convert.java").templatePath("/templates/convert.ftl").build();
